...
class BackgroundGridItem extends ConsumerWidget {
  const BackgroundGridItem({super.key});
  ...
  Widget _buildLeadingIcon(BackgroundTaskState taskState) {
    if (taskState.isCompleted) {
      return Icon(Icons.check_circle, color: Colors.green, size: 60.sp);
